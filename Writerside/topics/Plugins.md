...
A versão 2.1 do Combo foi incluída para exibir os Layouts dos países. Esse valor diferenciado vêm direto da API e é exibido com a logo referente ao preço. 
